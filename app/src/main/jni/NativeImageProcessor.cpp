...
JNIEXPORT jintArray
Java_com_holenstudio_excamera2_util_ImageProcessUtil_applyRGBCurve(JNIEnv *env, jobject thiz,
...
JNIEXPORT jintArray
Java_com_holenstudio_excamera2_util_ImageProcessUtil_applyChannelCurves(JNIEnv *env, jobject thiz,
...
JNIEXPORT jintArray
Java_com_holenstudio_excamera2_util_ImageProcessUtil_doContrast(JNIEnv *env, jobject thiz,
...
JNIEXPORT jintArray
Java_com_holenstudio_excamera2_util_ImageProcessUtil_doColorOverlay(JNIEnv *env, jobject thiz,
...
JNIEXPORT jintArray
Java_com_holenstudio_excamera2_util_ImageProcessUtil_doSaturation(JNIEnv *env, jobject thiz,
