...
import com.holenstudio.excamera2.util.BezierSpline;
 ...
 */
public class ToneCurveSubfilter implements Filter.SubFilter {
    ...
    public Bitmap process(Bitmap inputImage) {
        ...
        return ImageProcessUtil.applyCurves(rgb, r, g, b, inputImage);
    }
